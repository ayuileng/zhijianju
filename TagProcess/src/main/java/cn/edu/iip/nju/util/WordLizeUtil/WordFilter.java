package cn.edu.iip.nju.util.WordLizeUtil;
...
public class WordFilter {
	...
	private  FilterSet set = new FilterSet(); // 存储首字
	private  Map<Integer, WordNode> nodes = new HashMap(1024, 1); // 存储节点
	private  Set<Integer> stopwdSet = new HashSet<>(); // 停顿词
	private  char SIGN = '*'; // 敏感词过滤替换
	private  Set<String> keyword = Sets.newHashSet();
...
//	}
	...
	public  void init(Set<String> keyword) {
		// 获取敏感词
		addSensitiveWord(keyword);
		addStopWord(Sets.newHashSet());
	}
