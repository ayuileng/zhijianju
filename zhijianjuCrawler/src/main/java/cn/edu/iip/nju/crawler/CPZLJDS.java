...
public class CPZLJDS implements Crawler {
    ...
    private final String[] basicURLs = {"http://cpzljds.aqsiq.gov.cn/gzyw_1/",
            "http://cpzljds.aqsiq.gov.cn/ccbhgcp/"};
    ...
    private void downloadAttachment() throws Exception {
        ...
        Resource resource = new FileSystemResource("C:\\Users\\yajima\\Desktop\\zhijianju\\zhijianju\\src\\main\\resources\\fileNew");
